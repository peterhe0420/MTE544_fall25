...
class motion_executioner(Node):
    ...
    def __init__(self, motion_type=0):
        ...
        ####### Added Counter For Spiral Motion #######
    ...
    def imu_callback(self, imu_msg: Imu):
        self.imu_logger.log_values([imu_msg.linear_acceleration.x,
                                    ...
                                    Time.from_msg(imu_msg.header.stamp).nanoseconds])  # log imu msgs
    ...
    def odom_callback(self, odom_msg: Odometry):
        ...
        self.odom_logger.log_values([odom_msg.pose.pose.position.x,
                                     ...
                                     theta,
                                     Time.from_msg(odom_msg.header.stamp).nanoseconds])  # log odom msgs
    ...
    def laser_callback(self, laser_msg: LaserScan):
        ...
        self.laser_logger.log_values([laser_msg.ranges,
                                      ...
                                      Time.from_msg(
                                          laser_msg.header.stamp).nanoseconds])  # log laser msgs with position msg at that time
    ...
    def timer_callback(self):
        ...
        if not self.successful_init:
            print("not successful init\n")
            print("self.odom_initialized: ", self.odom_initialized)
            print("self.laser_initialized: ", self.laser_initialized)
            print("self.imu_initialized: ", self.imu_initialized)
            return
    ...
    def make_spiral_twist(self):
        ...
        msg.linear.x = min(0.01 * self.spiral_counter, 2.0)  # start low, increase as we go
        msg.angular.z = 1.0
